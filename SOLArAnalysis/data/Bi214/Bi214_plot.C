 ...
 * @file        Bi214_plot.C
 * @created     Tue May 02, 2023 15:56:40 CEST
 */
...
void Bi214_plot(const char* file_path) 
{
  ...
  TH1D* hTime = new TH1D("hTime", "#Delta#it{t};Time [ns];Entries", 100, 0, 2e6);
