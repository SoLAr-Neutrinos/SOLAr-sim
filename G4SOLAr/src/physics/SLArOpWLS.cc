...
//              2025-08-05 - Adaptation for SOLAr-sim
////////////////////////////////////////////////////////////////////////
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void SLArOpWLS::PreparePhysicsTable(const G4ParticleDefinition&) { Initialise(); }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void SLArOpWLS::Initialise()
{
                                         ...
                                         const G4Step& aStep)
{
  ...
  if(verboseLevel > 1)
  {
    G4cout << "\n** SLArOpWLS: Photon absorbed! **" << G4endl;
  }
  ...
  for(G4int i = 0; i < NumPhotons; ++i)
  {
    ...
    if(sampledEnergy > primaryEnergy)
    {
      if(verboseLevel > 1)
      {
        G4cout << " *** SLArOpWLS: One less WLS photon will be returned ***"
               << G4endl;
      }
      NumberOfPhotons--;
      if(NumberOfPhotons == 0)
      {
        ...
        {
          G4cout
            << " *** SLArOpWLS: No WLS photon can be sampled for this primary ***"
            << G4endl;
        }
        // return unchanged particle and no secondaries
        aParticleChange.SetNumberOfSecondaries(0);
    ...
    {
      G4cout << "SLArOpWLS: Created photon with energy: " << sampledEnergy
             << G4endl;
    }
  ...
  if(verboseLevel > 1)
  {
    G4cout << "\n Exiting from SLArOpWLS::DoIt -- NumberOfSecondaries = "
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void SLArOpWLS::BuildPhysicsTable(const G4ParticleDefinition&)
{
  if(theIntegralTable)
  {
    theIntegralTable->clearAndDestroy();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double SLArOpWLS::GetMeanFreePath(const G4Track& aTrack, G4double,
                                  G4ForceCondition*)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void SLArOpWLS::UseTimeProfile(const G4String name)
{
  ...
  {
    G4Exception("SLArOpWLS::UseTimeProfile", "em0202", FatalException,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void SLArOpWLS::SetVerboseLevel(G4int verbose)
{
