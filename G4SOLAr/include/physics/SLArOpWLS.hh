...
class SLArOpWLS : public G4VDiscreteProcess
{
 public:
  explicit SLArOpWLS(const G4String& processName = "OpWLS",
 ...
 private:
  SLArOpWLS(const SLArOpWLS& right) = delete;
  SLArOpWLS& operator=(const SLArOpWLS& right) = delete;
...
inline G4bool SLArOpWLS::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  return (&aParticleType == G4OpticalPhoton::OpticalPhoton());
}

inline G4PhysicsTable* SLArOpWLS::GetIntegralTable() const
{
  return theIntegralTable;
}

inline void SLArOpWLS::DumpPhysicsTable() const
{
